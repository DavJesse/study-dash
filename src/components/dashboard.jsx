...
console.log('Dashboard Data: ', data)
    ...
    return (
        <div className="flex flex-col">
            {/* Name Card */}
            <div className="w-[95%] xl:w-[80%] h-fit bg-white/15 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-[10px] backdrop-blur-md border border-white/10 shadow-[0_0_40px_rgba(8,7,16,0.6)] px-[20px] py-[20px] md:px-[35px] md:py-[30px] justify-center z-10">
